...
filtered_data_summer.to_csv('filtered_data_dir_summer5.csv', index=False)
...
plt.title('Feature Importance from RF', fontsize=20)
plt.yticks(fontsize=20)
plt.xticks(fontsize=20)
plt.savefig('feature_importance_RF.tiff', format='tiff', dpi=300)
plt.show()
...
ax.set_title('PM2.5 Density Heatmap from RF', fontsize=20)
plt.xlim(-5, 25)  # Set x-axis limit
plt.ylim(-5, 25)  # Set y-axis limit
plt.savefig('density_heatmap_RF.tiff', format='tiff', dpi=300)
plt.show()
...
plt.title('Actual vs Predicted PM2.5 2D Histogram from RF', fontsize=20)
plt.savefig('2D_histogram_RF.tiff', format='tiff', dpi=300)
plt.show()